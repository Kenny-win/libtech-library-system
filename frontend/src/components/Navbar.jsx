        ...
        <div className="flex justify-between h-16 items-center">
              ...
              {role === "admin" && (
                <>
                  ...
                  <div className="relative group py-5">
                    <button
                      className={`flex items-center gap-1 text-sm font-bold whitespace-nowrap transition-colors cursor-pointer ${
                        [
                          "kategori",
                          "manajemen-user",
                          "reset-password",
          ...
          <div className="flex items-center gap-3 md:gap-4 shrink-0 ml-4">
            ...
            <button
              ...
              className="xl:hidden p-1.5 rounded-md text-slate-500 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 cursor-pointer"
            >
              <svg
                className="w-6 h-6"
                fill="none"
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-3 flex flex-col gap-3 shadow-inner">
          {role === "admin" && (
            <button
              onClick={() => {
                setActivePage("dasbor");
                setIsMobileMenuOpen(false);
              }}
              className={`text-left text-sm font-bold px-3 py-2 rounded-lg transition-colors ${activePage === "dasbor" ? "bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400" : "text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700"}`}
            >
              📈 Dasbor
            </button>
          )}
          ...
          <button
            ...
            className={`text-left text-sm font-bold px-3 py-2 rounded-lg transition-colors ${activePage === "katalog" ? "bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400" : "text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700"}`}
          >
            📚 Katalog Buku
          </button>
          <button
            onClick={() => {
              setActivePage("pinjamanku");
              setIsMobileMenuOpen(false);
            }}
            className={`text-left text-sm font-bold px-3 py-2 rounded-lg transition-colors ${activePage === "pinjamanku" ? "bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400" : "text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700"}`}
          >
            📖 Pinjamanku
          </button>
          ...
          {role === "admin" && (
            <>
              <button
                onClick={() => {
                  setActivePage("peminjaman");
                  setIsMobileMenuOpen(false);
                }}
                className={`text-left text-sm font-bold px-3 py-2 rounded-lg transition-colors ${activePage === "peminjaman" ? "bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400" : "text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700"}`}
              >
                🔄 Peminjaman
              </button>
              ...
              <div className="border-t border-slate-200 dark:border-slate-600 my-1 pt-2">
                <span className="px-3 text-[10px] font-black text-slate-400 uppercase tracking-wider mb-2 block">
                  Data Master
                </span>
                <button
                  onClick={() => {
                  ...
                  className={`w-full text-left text-sm font-bold px-3 py-2 rounded-lg transition-colors ${activePage === "kategori" ? "bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400" : "text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700"}`}
                >
                  📂 Kategori Buku
                </button>
                <button
